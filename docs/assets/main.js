(() => {
    ...
    var Re = Object.getPrototypeOf, _e = Object.prototype.hasOwnProperty;
    var Me = t => J(t, "__esModule", {value: !0});
    var Fe = (t, e) => () => (e || t((e = {exports: {}}).exports, e), e.exports);
    var De = (t, e, r, n) => {
        if (e && typeof e == "object" || typeof e == "function") for (let i of Oe(e)) !_e.call(t, i) && (r || i !== "default") && J(t, i, {
            get: () => e[i],
            enumerable: !(n = Pe(e, i)) || n.enumerable
        });
        return t
    }, Ae = (t, e) => De(Me(J(t != null ? Ce(Re(t)) : {}, "default", !e && t && t.__esModule ? {
        get: () => t.default,
        enumerable: !0
    ...
    var de = Fe((ce, he) => {
        (function () {
            ...
            t.tokenizer = function (e, r) {
                ...
                if (Array.isArray(e)) return e.map(function (p) {
...
`, e)
            ...
            t.Vector = function (e) {
                ...
                for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, u = 0, l = 0, h = 0; l < s && h < o;) a = n[l], u = i[h], a < u ? l += 2 : a > u ? h += 2 : a == u && (r += n[l + 1] * i[h + 1], l += 2, h += 2);
                return r
            ...
            t.stemmer = function () {
                var e = {
                    ...
                    n = "[^aeiou]", i = "[aeiouy]", s = n + "[^aeiouy]*", o = i + "[aeiou]*",
                    a = "^(" + s + ")?" + o + s, u = "^(" + s + ")?" + o + s + "(" + o + ")?$",
                    l = "^(" + s + ")?" + o + s + o + s, h = "^(" + s + ")?" + i, p = new RegExp(a), v = new RegExp(l),
                    b = new RegExp(u), y = new RegExp(h), E = /^(.+?)(ss|i)es$/, f = /^(.+?)([^s])s$/, m = /^(.+?)eed$/,
                    T = /^(.+?)(ed|ing)$/, w = /.$/, k = /(at|bl|iz)$/, M = new RegExp("([^aeiouylsz])\\1$"),
                    j = new RegExp("^" + s + i + "[^aeiouwxy]$"), V = /^(.+?[^aeiou])y$/,
                    ...
                    $ = /^(.+?)(s|t)(ion)$/, P = /^(.+?)e$/, W = /ll$/, U = new RegExp("^" + s + i + "[^aeiouwxy]$"),
                    z = function (c) {
                        var g, O, S, d, x, R, D;
                        if (c.length < 3) return c;
                        if (S = c.substr(0, 1), S == "y" && (c = S.toUpperCase() + c.substr(1)), d = E, x = f, d.test(c) ? c = c.replace(d, "$1$2") : x.test(c) && (c = c.replace(x, "$1$2")), d = m, x = T, d.test(c)) {
                            var L = d.exec(c);
                            d = p, d.test(L[1]) && (d = w, c = c.replace(d, ""))
                        } else if (x.test(c)) {
                            var L = x.exec(c);
                            g = L[1], x = y, x.test(g) && (c = g, x = k, R = M, D = j, x.test(c) ? c = c + "e" : R.test(c) ? (d = w, c = c.replace(d, "")) : D.test(c) && (c = c + "e"))
                        }
                        if (d = V, d.test(c)) {
                            var L = d.exec(c);
                            g = L[1], c = g + "i"
            ...
            t.TokenSet = function () {
                ...
                for (var n = new t.TokenSet, i = [{node: n, editsRemaining: r, str: e}]; i.length;) {
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length > 1) {
                            var h = s.str.charAt(0), p = s.str.charAt(1), v;
                            p in s.node.edges ? v = s.node.edges[p] : (v = new t.TokenSet, s.node.edges[p] = v), s.str.length == 1 && (v.final = !0), i.push({
                                node: v,
                                editsRemaining: s.editsRemaining - 1,
                                str: h + s.str.slice(2)
                            })
                ...
                for (var r = new t.TokenSet, n = void 0, i = [{qNode: e, output: r, node: this}]; i.length;) {
                    n = i.pop();
                    for (var s = Object.keys(n.qNode.edges), o = s.length, a = Object.keys(n.node.edges), u = a.length, l = 0; l < o; l++) for (var h = s[l], p = 0; p < u; p++) {
                        var v = a[p];
                        if (v == h || h == "*") {
                            var b = n.node.edges[v], y = n.qNode.edges[h], E = b.final && y.final, f = void 0;
                            v in n.output.edges ? (f = n.output.edges[v], f.final = f.final || E) : (f = new t.TokenSet, f.final = E, n.output.edges[v] = f), i.push({
                                qNode: y,
                                output: f,
                                node: b
                            })
            ...
            t.Index = function (e) {
                ...
                for (var u = 0; u < r.clauses.length; u++) {
                    var l = r.clauses[u], h = null, p = t.Set.empty;
                    ...
                    for (var v = 0; v < h.length; v++) {
                        ...
                        for (var T = 0; T < E.length; T++) for (var w = E[T], k = this.invertedIndex[w], M = k._index, f = 0; f < l.fields.length; f++) {
                            var m = l.fields[f], j = k[m], V = Object.keys(j), B = w + "/" + m, q = new t.Set(V);
                            if (l.presence == t.Query.presence.REQUIRED && (p = p.union(q), o[m] === void 0 && (o[m] = t.Set.complete)), l.presence == t.Query.presence.PROHIBITED) {
                            ...
                            if (i[m].upsert(M, l.boost, function (Qe, Ie) {
                                ...
                                for (var H = 0; H < V.length; H++) {
                                    var $ = V[H], P = new t.FieldRef($, m), W = j[$], U;
                    ...
                    if (l.presence === t.Query.presence.REQUIRED) for (var f = 0; f < l.fields.length; f++) {
                        var m = l.fields[f];
                        o[m] = o[m].intersect(p)
                    }
                }
                ...
                var c = Object.keys(n), g = [], O = Object.create(null);
                if (r.isNegated()) {
                    c = Object.keys(this.fieldVectors);
                    for (var u = 0; u < c.length; u++) {
                        var P = c[u], S = t.FieldRef.fromString(P);
                        n[P] = new t.MatchData
                    }
                }
                for (var u = 0; u < c.length; u++) {
                    var S = t.FieldRef.fromString(c[u]), d = S.docRef;
                    if (!!z.contains(d) && !F.contains(d)) {
                        var x = this.fieldVectors[S], R = i[S.fieldName].similarity(x), D;
                        if ((D = O[d]) !== void 0) D.score += R, D.matchData.combine(n[S]); else {
            ...
            t.Builder = function () {
                ...
                for (var s = 0; s < i.length; s++) {
                    var o = i[s], a = this._fields[o].extractor, u = a ? a(e) : e[o],
                        l = this.tokenizer(u, {fields: [o]}), h = this.pipeline.run(l), p = new t.FieldRef(n, o),
                    ...
                    for (var b = 0; b < h.length; b++) {
                        ...
                        for (var m = 0; m < this.metadataWhitelist.length; m++) {
                            var T = this.metadataWhitelist[m], w = y.metadata[T];
                ...
                for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                    for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName, u = this.fieldLengths[o], l = new t.Vector, h = this.fieldTermFrequencies[o], p = Object.keys(h), v = p.length, b = this._fields[a].boost || 1, y = this._documents[o.docRef].boost || 1, E = 0; E < v; E++) {
                        var f = p[E], m = h[f], T = this.invertedIndex[f]._index, w, k, M;
                        i[f] === void 0 ? (w = t.idf(this.invertedIndex[f], this.documentCount), i[f] = w) : w = i[f], k = w * ((this._k1 + 1) * m) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + m), k *= b, k *= y, M = Math.round(k * 1e3) / 1e3, l.insert(T, M)
                    }
                    e[o] = l
                }
                this.fieldVectors = e
    ...
    var Z = class {
        ...
        removeEventListener(e, r) {
            ...
            for (let i = 0, s = n.length; i < s; i++) if (n[i] === r) {
                n.splice(i, 1);
                return
            }
        }
    ...
    var ee = class extends Z {
        constructor() {
            ...
            this.height = 0;
            this.showToolbar = !0;
            this.toolbar = document.querySelector(".tsd-page-toolbar"), this.secondaryNav = document.querySelector(".tsd-navigation.secondary"), window.addEventListener("scroll", K(() => this.onScroll(), 10)), window.addEventListener("resize", K(() => this.onResize(), 10)), this.onResize(), this.onScroll()
        }
        ...
        hideShowToolbar() {
            ...
            this.showToolbar = this.lastY >= this.scrollTop || this.scrollTop <= 0, e !== this.showToolbar && (this.toolbar.classList.toggle("tsd-page-toolbar--hide"), (r = this.secondaryNav) == null || r.classList.toggle("tsd-navigation--toolbar-hide")), this.lastY = this.scrollTop
        }
    }, I = ee;
    I.instance = new ee;
    var te = class extends Q {
        constructor(e) {
            ...
            this.anchors = [];
            this.index = -1;
            I.instance.addEventListener("resize", () => this.onResize()), I.instance.addEventListener("scroll", r => this.onScroll(r)), this.createAnchors()
        }

        createAnchors() {
            let e = window.location.href;
            e.indexOf("#") != -1 && (e = e.substr(0, e.indexOf("#"))), this.el.querySelectorAll("a").forEach(r => {
                let n = r.href;
                if (n.indexOf("#") == -1 || n.substr(0, e.length) != e) return;
                let i = n.substr(n.indexOf("#") + 1), s = document.querySelector("a.tsd-anchor[name=" + i + "]"),
                    o = r.parentNode;
        ...
        onScroll(e) {
            let r = e.detail.scrollTop + 5, n = this.anchors, i = n.length - 1, s = this.index;
    ...
    function pe() {
        ...
        let r = document.querySelector("#tsd-search input"), n = document.querySelector("#tsd-search .results");
        if (!r || !n) throw new Error("The input field or the result list wrapper was not found");
        let i = !1;
        n.addEventListener("mousedown", () => i = !0), n.addEventListener("mouseup", () => {
    ...
    function Ve(t, e, r, n) {
        r.addEventListener("input", ue(() => {
            ze(t, e, r, n)
        }, 200));
        let i = !1;
        r.addEventListener("keydown", s => {
            i = !0, s.key == "Enter" ? Ne(e, r) : s.key == "Escape" ? r.blur() : s.key == "ArrowUp" ? me(e, -1) : s.key === "ArrowDown" ? me(e, 1) : i = !1
    ...
    function He(t, e) {
        t.index || window.searchData && (e.classList.remove("loading"), e.classList.add("ready"), t.data = window.searchData, t.index = fe.Index.load(window.searchData.index))
    }

    function ze(t, e, r, n) {
        if (He(n, t), !n.index || !n.data) return;
        e.textContent = "";
        let i = r.value.trim(), s = n.index.search(`*${i}*`);
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            let u = n.data.rows[Number(s[o].ref)], l = ve(u.name, i);
    ...
    function me(t, e) {
        ...
        if (!r) r = t.querySelector(e == 1 ? "li:first-child" : "li:last-child"), r && r.classList.add("current"); else {
            let n = r;
            if (e === 1) do n = n.nextElementSibling; while (n instanceof HTMLElement && n.offsetParent == null); else do n = n.previousElementSibling; while (n instanceof HTMLElement && n.offsetParent == null);
    ...
    function ve(t, e) {
        if (e === "") return t;
        let r = t.toLocaleLowerCase(), n = e.toLocaleLowerCase(), i = [], s = 0, o = r.indexOf(n);
    ...
    var ge = class {
        ...
        constructor(e) {
            ...
            this.groups = [];
            this.index = -1;
            this.createGroups(), this.container && (this.el.classList.add("active"), Array.from(this.el.children).forEach(r => {
        ...
        setIndex(e) {
            ...
            if (this.index > -1) {
                ...
                n.removeClass("current").addClass("fade-out"), r.addClass("current"), r.addClass("fade-in"), I.instance.triggerResize(), setTimeout(() => {
    ...
    var C = "mousedown", ye = "mousemove", _ = "mouseup", G = {x: 0, y: 0}, xe = !1, ie = !1, Be = !1, A = !1,
    ...
    document.addEventListener(ye, t => {
        if (!!ie && !A) {
            let e = C == "touchstart" ? t.targetTouches[0] : t, r = G.x - (e.pageX || 0), n = G.y - (e.pageY || 0);
    ...
    var se = class extends Q {
        constructor(e) {
            super(e);
            this.className = this.el.dataset.toggle || "", this.el.addEventListener(_, r => this.onPointerUp(r)), this.el.addEventListener("click", r => r.preventDefault()), document.addEventListener(C, r => this.onDocumentPointerDown(r)), document.addEventListener(_, r => this.onDocumentPointerUp(r))
        }
    ...
    var oe = class {
        constructor(e, r) {
            this.key = e, this.value = r, this.defaultValue = r, this.initialize(), window.localStorage[this.key] && this.setValue(this.fromLocalStorage(window.localStorage[this.key]))
        }
        ...
        initialize() {
            ...
            this.select.addEventListener(C, r), this.select.addEventListener("mouseover", r), this.select.addEventListener("mouseleave", n), this.select.querySelectorAll("li").forEach(i => {
        ...
        handleValueChange(e, r) {
            ...
            n && i && (n.classList.add("selected"), i.textContent = n.textContent), document.documentElement.classList.remove("toggle-" + e), document.documentElement.classList.add("toggle-" + r)
        }
        ...
        constructor(e) {
            super(e);
            this.optionVisibility = new Ee("visibility", "private"), this.optionInherited = new ae("inherited", !0), this.optionExternals = new ae("externals", !0)
        }
    ...
    function be(t) {
        ...
        t.value = e, we(e), t.addEventListener("change", () => {
